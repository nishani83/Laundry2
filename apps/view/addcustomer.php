                            ...
                            <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <form method="post" action="../controller/customercontroller.php?status=Add" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" required="" name="address" id="address" placeholder="address" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" required="" name="contactNo" id="contactNo" placeholder="Contact Number" class="form-control" />
                                        </div>
                                    </div>
