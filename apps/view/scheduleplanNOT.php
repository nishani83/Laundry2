...
$result = $obj->viewAvailableDrivers($leave); //To get all employees info
...
<!--                                                    <table>
        ...
        <script >
            ...
            $('#datepick').change(function () {
                ...
                window.location.replace("?ldate=" + checkval);
            ...
            function load_date(val)
            {
                ...
                window.location = "scheduleplan.php?ldate=" + val;
