...
$ob = new dbconnection();
$con = $ob->connection();
$obj = new task; //To create an object using task class
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Task Status Count for the Month</h1>
                        </div><!-- /.col -->
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <ul class="nav nav-tabs mb-4">
                        <li class="nav-item">
                            <a class="nav-link" href="reporttasks.php">
                    ...
                    <div class="year-select d-flex align-center justify-content-end mb-4">
                        <?php 
                        ...
                        <button id="print" class="print-btn-style mr-4">PRINT</button>
                    </div>
                    <div>
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                <div class="card">
                                    <h3 class="mt-3 ml-3">Task Count of the Month - <?php echo $s_month;?> | Year <?php echo $s_year;?></h3>
                                    <div class="card-body">
                                        <?php
                                        $result1 = $obj->tasksAvailabilityMonth($s_year, $month_num);
...
foreach ($status_array as $task_status) {
  ...
  $result = $obj->tasksCountMonth($month_num, $s_year, $task_status);
