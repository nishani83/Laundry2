...
<html lang="en">
                                ...
                                <form method="post" action="../controller/schedulecontroller.php?status=Add" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" id="datepicker" name="datepicker"  onChange="load_date(this.value)" >
   ...
   <!--                                                    <option value="<?php //echo $rowe['empID'];                                        ?>">-->
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <select name="del[]" id="del" class="form-control"  multiple="multiple">
                                                <?php
...
//                                                        $("#del").bsMultiSelect();
                                                    ...
                                                    if (dateSelected) {
                                                        ...
                                                        /*for (var i = 0; i < drivers.length; i++) {
                                                         console.log(drivers[i].driverID);
                                                         }*/
                                                        ...
                                                        let driverSelectAgain = $("#driverID");


                                                        for (var i = 0; i < driverSelectAgain.length; i++) {
                                                            console.log(driverSelectAgain[i])
                                                            if (driverSelectAgain[i] !== item.empName) {
